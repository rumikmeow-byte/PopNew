...
from config import BOT_WALLET_MNEMONIC, BOT_WALLET_ADDRESS, TON_API_KEY
...
async def get_wallet():
    if not BOT_WALLET_MNEMONIC:
        raise ValueError("BOT_WALLET_MNEMONIC не задан")
    mnemonic = BOT_WALLET_MNEMONIC.split()
    wallet = await Wallet.from_mnemonic(mnemonic, version="v4r2", workchain=0)
    return wallet
